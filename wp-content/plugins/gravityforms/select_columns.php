        ...
        <html>
            <head>
                ...
                <style type="text/css">
                    ...
                    .column-arrow-mid {float:left; width:45px; height:250px; background-image:url(<?php echo GFCommon::get_base_url(); ?>/wp-content/themes/localedge/images/arrow-rightleft.jpg); background-repeat:no-repeat; background-position:center center; margin-top:26px;}
